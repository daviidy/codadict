                        ...
                        <div class="col-sm-12">
                            <div class="styles__CategoryButtons-vgii8s-3 hqqZXZ">
                                ...
                                <a class="styles__CategoryButton-vgii8s-4 fUQatb" href="{{url('categories')}}">
                                    ...
                                    <h4 class="MuiTypography-root Typography-ngwq8z-0 styles__CategoryButton_Title-vgii8s-5 eBqjAL MuiTypography-h4 MuiTypography-alignCenter" m="0,2">Gestion des projets</h4>
                                </a>
                                <a class="styles__CategoryButton-vgii8s-4 fUQatb" href="{{url('users')}}">
                                    ...
                                    <h4 class="MuiTypography-root Typography-ngwq8z-0 styles__CategoryButton_Title-vgii8s-5 eBqjAL MuiTypography-h4 MuiTypography-alignCenter" m="0,2">Gestion des utilisateurs</h4>
                                </a>
