...
.hqqZXZ{display:flex;width:100%;height:35%; flex-wrap: wrap;}
                                ...
                                <div class="au-breadcrumb-content">
                                    ...
                                    <a href="{{route('projects.create')}}">
                                      <button class="au-btn au-btn-icon au-btn--green">
                                          <i class="zmdi zmdi-plus"></i>Ajouter un projet
                                      </button>
                                    </a>
                                </div>
                            </div>
                          ...
                          <div class="row">
                              <div class="col-sm-12">
                                  <div class="styles__CategoryButtons-vgii8s-3 hqqZXZ">
                                      <a class="styles__CategoryButton-vgii8s-4 fUQatb" href="{{route('projects.index')}}">
                                          ...
                                          <h4 class="MuiTypography-root Typography-ngwq8z-0 styles__CategoryButton_Title-vgii8s-5 eBqjAL MuiTypography-h4 MuiTypography-alignCenter" m="0,2">Gérer vos Projets</h4>
                                      </a>
                                      <a class="styles__CategoryButton-vgii8s-4 fUQatb" href="{{route('projects.create')}}">
                                          ...
                                          <h4 class="MuiTypography-root Typography-ngwq8z-0 styles__CategoryButton_Title-vgii8s-5 eBqjAL MuiTypography-h4 MuiTypography-alignCenter" m="0,2">Créer un projet </h4>
                                      </a>
                                      <a class="styles__CategoryButton-vgii8s-4 fUQatb" href="/users">
                                          ...
                                          <h4 class="MuiTypography-root Typography-ngwq8z-0 styles__CategoryButton_Title-vgii8s-5 eBqjAL MuiTypography-h4 MuiTypography-alignCenter" m="0,2">Gérer votre compte</h4>
                                      </a>

                                      <a class="styles__CategoryButton-vgii8s-4 fUQatb" href="{{url('pricings')}}" style="display: none">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                      <div class="row">
                          <div class="col-sm-12">
                              <div class="styles__CategoryButtons-vgii8s-3 hqqZXZ">
                                  <a class="styles__CategoryButton-vgii8s-4 fUQatb" href="/videos">
                                      <div class="styles__CategoryButton_Icon-vgii8s-6 fjEdZT"><svg width="161" height="147" viewBox="0 0 161 147" fill="none">
                                              <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M135.204 119.528H25.7964C23.7044 119.518 22.011 117.804 22 115.686V28.842C22.011 26.724 23.7044 25.01 25.7964 25H135.168C137.26 25.01 138.953 26.724 138.964 28.842V115.686C138.954 117.789 137.283 119.497 135.206 119.528H135.204ZM29.301 35.087H68.3656Z"
                                                fill="#DAE1F2"></path>
                                      ...
                                      <h4 class="MuiTypography-root Typography-ngwq8z-0 styles__CategoryButton_Title-vgii8s-5 eBqjAL MuiTypography-h4 MuiTypography-alignCenter" m="0,2">Gérer vos vidéos</h4>
                                  </a>
                                  <a class="styles__CategoryButton-vgii8s-4 fUQatb" href="/categories">
                                      <div class="styles__CategoryButton_Icon-vgii8s-6 fjEdZT"><svg width="164" height="144" viewBox="0 0 164 144" fill="none">
                                              <rect x="20" y="82" width="135" height="36" rx="18" fill="#FFCDB2"></rect>
                                              <rect x="41" y="112" width="95" height="6" fill="#ED956E"></rect>
                                              <path d="M9 34L21 44.5L26.5 67.5L32.5 69.5H39.5L46.5 83L32.5 84L24 89.5L5 52L1 37L9 34Z" fill="#E3E3E3"></path>
                                      ...
                                      <h4 class="MuiTypography-root Typography-ngwq8z-0 styles__CategoryButton_Title-vgii8s-5 eBqjAL MuiTypography-h4 MuiTypography-alignCenter" m="0,2">Gérer vos catégories </h4>
                                  </a>
                                  <a class="styles__CategoryButton-vgii8s-4 fUQatb" href="/users">
                                      <div class="styles__CategoryButton_Icon-vgii8s-6 fjEdZT"><svg width="162" height="145" viewBox="0 0 162 145" fill="none">
                                              <path d="M21 21L25.5 9L38.5 2H115L127 7L135.5 19V138L106 116H39.5L27 110.5L21 96.5V21Z" fill="#F8F8FF"></path>
