...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        if (Auth::check() && Auth::user()->isAdmin()) {
            ...
            return view('users.user_admin.categories.index', ['categories' => $categories]);
        }
        else {
    ...
    {
        if (Auth::check() && Auth::user()->isAdmin()) {
            return view('users.user_admin.categories.create');
        }
        else {
            return redirect('home');
        }
    ...
    {
        if (Auth::check() && Auth::user()->isAdmin()) {
            return view('users.user_admin.categories.edit', ['category' => $category]);
        }
        else {
            return redirect('home');
        }
